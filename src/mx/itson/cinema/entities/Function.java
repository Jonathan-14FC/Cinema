...
public class Function {
  ...
  private String date;
    ...
    public static List<Function> getAll(){
     ...
     PreparedStatement statement = conexion.prepareStatement("SELECT m.idMovie, m.nameMovie, m.duration, m.category, m.description, m.nameActors, h.numberHall, h.availability,j.idFunctionm, j.date FROM functionm j INNER JOIN movie m ON j.idMovie = m.idMovie INNER JOIN hall h ON j.idHall = h.idHall");
